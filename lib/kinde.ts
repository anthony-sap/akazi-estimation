...
export const createUserInKinde = async (
  ...
  try {
    ...
    const url = `${env.KINDE_DOMAIN}/api/v1/user`;
...
export const updateUserInKinde = async (
  ...
  try {
    const accessToken: string = await getKindeAccessToken();
    const url = `${env.KINDE_DOMAIN}/api/v1/user?id=${user.id}`;
    const headers: Record<string, string> = {
      "Content-Type": "application/json",
      Accept: "application/json",
      Authorization: `Bearer ${accessToken}`,
...
export const updateUserPropertiesInKinde = async (
  ...
  try {
    const accessToken: string = await getKindeAccessToken();
    const url = `${env.KINDE_DOMAIN}/api/v1/users/${userSub}/properties`;
    const headers: Record<string, string> = {
      "Content-Type": "application/json",
      Accept: "application/json",
      Authorization: `Bearer ${accessToken}`,
...
export const updateUserRolesInKinde = async (
  ...
  try {
    const accessToken: string = await getKindeAccessToken();
    const url = `${env.KINDE_DOMAIN}/api/v1/organizations/${env.KINDE_DEFAULT_ORG_CODE}/users`;
    const headers: Record<string, string> = {
      "Content-Type": "application/json",
      Accept: "application/json",
      Authorization: `Bearer ${accessToken}`,
...
export const getUserFromKinde = async (sub: string): Promise<ResponseData> => {
  try {
    const accessToken: string = await getKindeAccessToken();
    const url = `${env.KINDE_DOMAIN}/api/v1/user?id=${sub}`;
    const headers: Record<string, string> = {
      "Content-Type": "application/json",
      Accept: "application/json",
      Authorization: `Bearer ${accessToken}`,
...
export const findUsersInKinde = async (
  ...
  try {
    const accessToken: string = await getKindeAccessToken();
    let url = `${env.KINDE_DOMAIN}/api/v1/users?`;
...
export const getRolesListFromKinde = async (): Promise<any> => {
  try {
    const accessToken: string = await getKindeAccessToken();
    const url = `${env.KINDE_DOMAIN}/api/v1/roles?page_size=500`;
    const headers: Record<string, string> = {
      "Content-Type": "application/json",
      Accept: "application/json",
      Authorization: `Bearer ${accessToken}`,
...
export const getRolePermissionsFromKinde = async (
  ...
  try {
    const accessToken: string = await getKindeAccessToken();
    const url = `${env.KINDE_DOMAIN}/api/v1/roles/${kindeRoleId}/permissions?page_size=500`;
    const headers: Record<string, string> = {
      "Content-Type": "application/json",
      Accept: "application/json",
      Authorization: `Bearer ${accessToken}`,
